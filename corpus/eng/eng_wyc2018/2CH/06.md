...
chapter: "6"
ref: "2CH 6"
doc_id: "eng_wyc2018:2CH:6"
verse_count: "42"
source_db_sha256: "8e3d7faec7d0cf15b7a289ddb2de6d13717e645600026491ee6759319073a6e1"
chapter_sha256: "2b678665b6b1599aa33c13ed6bee460114ea59d13578f1bc14267c1a4bc46ad9"
---
...
**28** (And) If that hunger riseth in the land, and pestilence, and rust, and wind destroying corns, (or crops), and if that a locust, and (a) bruchus cometh; and if enemies besiege the gates of the city, after that the countries be destroyed (or after that the countryside is destroyed); and if (in) any manner vengeance and sickness oppresseth thy people;
...
**33** and thou shalt do all things, for which that pilgrim inwardly calleth thee, that all the people of (the) earth know thy name, and dread thee, as thy people Israel doeth; and that they know, that thy name is called on (in) this house, which I have builded to thy name. (and thou shalt do all the things, for which that pilgrim inwardly calleth thee, so that all the people of the earth can know thy name, and fear thee or and revere thee, as thy people Israel doeth; and so that they can know, that thy name is called on in this House, which I have built in honour of thy name.)
