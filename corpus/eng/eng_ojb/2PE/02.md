...
**5** And if Hashem, when he brought a mabbul (flood) upon the world of resha'im (evildoers), did not spare the ancient world, but preserved Noach, the eighth of the nefashot and a maggid of Tzidkanut (Righteousness);
...
**7** And if Hashem delivered Lot, a tzaddik distressed by the hitnahagut (conduct) of the mufkarim (lawless) walking in darchei zimah (the ways of licentiousness)
...
**10** Especially the ones going after the basar (flesh) in ta'avah (lust) producing tum'a (defilement) and the ones despising kol samchut. Bold and self-willed, these have no yirat Shomayim and therefore commit Chillul Hashem as they slander the glorious ones,
...
**22** The word of the true mashal (proverb) has overtaken them: KECHELEV SHAV AL KE'O (As a dog having returned to its own vomit), and a “chazir (swine) is washed only to wallow in the mud.”
