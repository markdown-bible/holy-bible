...
> put in the wheat in rows and the barley in the right place, and the spelt at its edges?[^17]
...
[^17]: The identification of some of these spices is in doubt, so versions have a variety of translations. In addition, some versions give different interpretations to the expressions translated here as in rows and in the right place , because these expressions are uncertain in Hebrew.
[^11887]: The identification of some of these spices is in doubt, so versions have a variety of translations. In addition, some versions give different interpretations to the expressions translated here as in rows and in the right place , because these expressions are uncertain in Hebrew.
