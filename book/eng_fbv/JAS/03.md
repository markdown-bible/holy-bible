...
**6** And the tongue is a fire! The tongue is a world of evil among the parts of the body. It disgraces all you are as a person, and can burn down the whole of your life, since it is set on fire by Gehenna.[^12]
...
[^12]: Gehenna: the trash dump outside of Jerusalem where fires were used to burn the trash. The word is used symbolically as the endpoint for the wicked. See note on Matthew 5:22.
[^11131]: Gehenna: the trash dump outside of Jerusalem where fires were used to burn the trash. The word is used symbolically as the endpoint for the wicked. See note on Matthew 5:22.
