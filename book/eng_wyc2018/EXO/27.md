...
**10** and twenty pillars, with so many brazen bases[^13], which pillars shall have silver hooks, and the holdings of those[^14]. (with twenty bronze pillars, and as many bronze bases, and the pillars shall have silver hooks and bands.)
...
[^13]: In the original text, throughout the rest of Exodus, ‘foundament/s’ and ‘base/s’ are used interchangeably in reference to the pillars. To avoid confusion, and to enhance comprehension, only ‘base/s’ will be used in this context.
[^14]: From the gloss for verse 38:10.
[^11336]: In the original text, throughout the rest of Exodus, ‘foundament/s’ and ‘base/s’ are used interchangeably in reference to the pillars. To avoid confusion, and to enhance comprehension, only ‘base/s’ will be used in this context.
[^11337]: From the gloss for verse 38:10.
