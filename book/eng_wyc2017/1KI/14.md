...
[^4]: That is, dung is not cleansed in itself, but the place in which the dung is, is cleansed, when the dung is cast out.
[^11039]: That is, dung is not cleansed in itself, but the place in which the dung is, is cleansed, when the dung is cast out.
